...
def preprocessData(inputDir, output_root):
    ...
    # info_file = join(inputDir, 'info.player.json')      # get the timestamp from the info.csv file
    ...
    #         if 'start_time_synced_s' in line:
...
if __name__ == '__main__':
	...
	input_dir = '/Users/azamatkaibaldiyev/GREYC_project/Pupil_labs/pupil/recordings/2024_01_16/001'
	output_dir = os.path.join(input_dir, 'Result_outputs')
	os.makedirs(output_dir, exist_ok = True)

	# parse arguments
	parser = argparse.ArgumentParser()
	parser.add_argument('--inputDir', default = input_dir, help='path to the raw pupil labs recording dir')
	parser.add_argument('--outputDir', default = output_dir,help='output directory root. Raw data will be written to recording specific dirs within this directory')
